...
const char* substrate_brainwallet_address_Ecdsa(struct ExternError*, const char* seed, const unsigned prefix);

const char* substrate_brainwallet_sign_Ecdsa(struct ExternError* err, const char* seed, const char* data);
...
const char* substrate_brainwallet_sign_with_ref_Ecdsa(struct ExternError*, int64_t seed_ref, const char* suri_suffix, const char* data);

const char* substrate_address_with_ref_Ecdsa(struct ExternError*, int64_t seed_ref, const char* suri_suffix, const unsigned prefix);
